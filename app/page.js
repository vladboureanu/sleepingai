  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-30">
        <div className="absolute w-32 h-32 bg-white bg-opacity-10 rounded-full blur-xl float-anim" 
             style={{top: '20%', left: '20%'}}></div>
        <div className="absolute w-48 h-48 bg-white bg-opacity-10 rounded-full blur-xl float-anim-alt" 
      ...
      <style jsx>{`
        ...
        .float-anim {
          animation: floatMotion 20s ease-in-out infinite;
        }
